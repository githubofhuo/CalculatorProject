...
public:
    ...
    void setupUi(QDialog *variableDialog)
    {
        if (variableDialog->objectName().isEmpty())
            variableDialog->setObjectName(QStringLiteral("variableDialog"));
    ...
    {
        variableDialog->setWindowTitle(QApplication::translate("variableDialog", "Check Variables", 0));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("variableDialog", "Variables", 0));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("variableDialog", "Value", 0));

        const bool __sortingEnabled = tableWidget->isSortingEnabled();
        tableWidget->setSortingEnabled(false);
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->item(0, 0);
        ___qtablewidgetitem2->setText(QApplication::translate("variableDialog", "X", 0));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->item(1, 0);
        ___qtablewidgetitem3->setText(QApplication::translate("variableDialog", "Y", 0));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->item(2, 0);
        ___qtablewidgetitem4->setText(QApplication::translate("variableDialog", "Z", 0));
        tableWidget->setSortingEnabled(__sortingEnabled);

        clearButton->setText(QApplication::translate("variableDialog", "Clear", 0));
        calcButton->setText(QApplication::translate("variableDialog", "Calculate", 0));
    } // retranslateUi
