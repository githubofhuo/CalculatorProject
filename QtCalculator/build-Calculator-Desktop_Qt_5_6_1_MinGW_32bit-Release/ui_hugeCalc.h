...
public:
    ...
    void setupUi(QWidget *HugeCalc)
    {
        if (HugeCalc->objectName().isEmpty())
            HugeCalc->setObjectName(QStringLiteral("HugeCalc"));
        ...
        complex_groupBox->setObjectName(QStringLiteral("complex_groupBox"));
        complex_groupBox->setGeometry(QRect(430, 10, 241, 168));
        fourOper_radioButton = new QRadioButton(complex_groupBox);
        fourOper_radioButton->setObjectName(QStringLiteral("fourOper_radioButton"));
        ...
        fourOperFirst_comboBox->setObjectName(QStringLiteral("fourOperFirst_comboBox"));
        ...
        fourOperFourth_comboBox->setObjectName(QStringLiteral("fourOperFourth_comboBox"));
        fourOperFourth_comboBox->setGeometry(QRect(194, 30, 39, 21));
        fourOperSecond_comboBox = new QComboBox(complex_groupBox);
        fourOperSecond_comboBox->setObjectName(QStringLiteral("fourOperSecond_comboBox"));
        fourOperSecond_comboBox->setGeometry(QRect(118, 30, 39, 21));
        fourOperThird_comboBox = new QComboBox(complex_groupBox);
        fourOperThird_comboBox->setObjectName(QStringLiteral("fourOperThird_comboBox"));
        ...
        factorial_radioButton->setObjectName(QStringLiteral("factorial_radioButton"));
        factorial_radioButton->setGeometry(QRect(10, 90, 51, 16));
        factorial_spinBox = new QSpinBox(complex_groupBox);
        factorial_spinBox->setObjectName(QStringLiteral("factorial_spinBox"));
        ...
        sqrtSecond_comboBox->setObjectName(QStringLiteral("sqrtSecond_comboBox"));
        ...
        factorialFirst_comboBox->setObjectName(QStringLiteral("factorialFirst_comboBox"));
        ...
        symtem_spinBox->setObjectName(QStringLiteral("symtem_spinBox"));
        ...
        simpleCalculator_pushButton->setObjectName(QStringLiteral("simpleCalculator_pushButton"));
        simpleCalculator_pushButton->setGeometry(QRect(160, 110, 75, 23));
        shift_spinBox = new QSpinBox(simple_groupBox);
        shift_spinBox->setObjectName(QStringLiteral("shift_spinBox"));
    ...
    {
        HugeCalc->setWindowTitle(QApplication::translate("HugeCalc", "BigInteger Tool", 0));
        input_groupBox->setTitle(QApplication::translate("HugeCalc", "Input", 0));
        input_comboBox->clear();
        input_comboBox->insertItems(0, QStringList()
         << QApplication::translate("HugeCalc", " A", 0)
         << QApplication::translate("HugeCalc", " B", 0)
         << QApplication::translate("HugeCalc", " C", 0)
        );
        input_pushButton->setText(QApplication::translate("HugeCalc", "Input", 0));
        fileInput_pushButton->setText(QApplication::translate("HugeCalc", "File Input", 0));
        clear_pushButton->setText(QApplication::translate("HugeCalc", "Clear", 0));
        output_groupBox->setTitle(QApplication::translate("HugeCalc", "Output", 0));
        sign_checkBox->setText(QApplication::translate("HugeCalc", "Sign", 0));
        space_checkBox->setText(QApplication::translate("HugeCalc", "Space", 0));
        section_checkBox->setText(QApplication::translate("HugeCalc", "Section", 0));
        output_pushButton->setText(QApplication::translate("HugeCalc", "Display", 0));
        ...
        fileOutput_pushButton->setText(QApplication::translate("HugeCalc", "File Output", 0));
        digital_checkBox->setText(QApplication::translate("HugeCalc", "Digit", 0));
        autoOutput_checkBox->setText(QApplication::translate("HugeCalc", "Auto Answer", 0));
        complex_groupBox->setTitle(QApplication::translate("HugeCalc", "High-Precision Calculate", 0));
        fourOper_radioButton->setText(QApplication::translate("HugeCalc", "Four:", 0));
        ...
        label_1->setText(QApplication::translate("HugeCalc", "=", 0));
        ...
        fourOperThird_comboBox->insertItems(0, QStringList()
         << QApplication::translate("HugeCalc", "+", 0)
         << QApplication::translate("HugeCalc", "-", 0)
         << QApplication::translate("HugeCalc", "*", 0)
         << QApplication::translate("HugeCalc", "/", 0)
         << QApplication::translate("HugeCalc", "%", 0)
        );
        power_radioButton->setText(QApplication::translate("HugeCalc", "Pow:", 0));
        ...
        label_2->setText(QApplication::translate("HugeCalc", "=", 0));
        time_checkBox->setText(QApplication::translate("HugeCalc", "Time:", 0));
        time_label->setText(QApplication::translate("HugeCalc", "0ms", 0));
        factorial_radioButton->setText(QApplication::translate("HugeCalc", "Fac:", 0));
        factorialSecond_comboBox->clear();
        factorialSecond_comboBox->insertItems(0, QStringList()
         << QApplication::translate("HugeCalc", " !", 0)
         << QApplication::translate("HugeCalc", " !!", 0)
        );
        complexCalculator_pushButton->setText(QApplication::translate("HugeCalc", "Calculate", 0));
        sqrt_radioButton->setText(QApplication::translate("HugeCalc", "Sqrt\357\274\232", 0));
        ...
        label_5->setText(QApplication::translate("HugeCalc", "=", 0));
        ...
        label_6->setText(QApplication::translate("HugeCalc", "'sqrt", 0));
        ...
        label_4->setText(QApplication::translate("HugeCalc", "=", 0));
        label_11->setText(QApplication::translate("HugeCalc", "\342\210\247", 0));
        simple_groupBox->setTitle(QApplication::translate("HugeCalc", "Simple Calculate", 0));
        ...
        elseSecond_comboBox->insertItems(0, QStringList()
         << QApplication::translate("HugeCalc", "<+>", 0)
         << QApplication::translate("HugeCalc", "vs", 0)
        );
        ...
        shift_radioButton->setText(QApplication::translate("HugeCalc", "Shift:", 0));
        shiftSecond_comboBox->clear();
        shiftSecond_comboBox->insertItems(0, QStringList()
         << QApplication::translate("HugeCalc", ">>=", 0)
         << QApplication::translate("HugeCalc", "<<=", 0)
         << QApplication::translate("HugeCalc", "shift", 0)
        );
        else_radioButton->setText(QApplication::translate("HugeCalc", "Else:", 0));
        system_radioButton->setText(QApplication::translate("HugeCalc", "System:", 0));
        ...
        label_7->setText(QApplication::translate("HugeCalc", "To:", 0));
        simpleCalculator_pushButton->setText(QApplication::translate("HugeCalc", "Calculate", 0));
    } // retranslateUi
