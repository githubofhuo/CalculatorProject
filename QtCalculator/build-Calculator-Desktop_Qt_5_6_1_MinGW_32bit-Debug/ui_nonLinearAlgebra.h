...
public:
    ...
    void setupUi(QWidget *nonLinearAlgebra)
    {
        if (nonLinearAlgebra->objectName().isEmpty())
            nonLinearAlgebra->setObjectName(QStringLiteral("nonLinearAlgebra"));
        ...
        multiplyPushButton->setObjectName(QStringLiteral("multiplyPushButton"));
        ...
        backspacePushButton->setObjectName(QStringLiteral("backspacePushButton"));
        ...
        powerPushButton->setObjectName(QStringLiteral("powerPushButton"));
        ...
        numGroupBox->setObjectName(QStringLiteral("numGroupBox"));
        numGroupBox->setGeometry(QRect(0, 0, 161, 131));
        num7PushButton = new QPushButton(numGroupBox);
        num7PushButton->setObjectName(QStringLiteral("num7PushButton"));
        ...
        num8PushButton->setObjectName(QStringLiteral("num8PushButton"));
        ...
        num9PushButton->setObjectName(QStringLiteral("num9PushButton"));
        ...
        num4PushButton->setObjectName(QStringLiteral("num4PushButton"));
        ...
        num5PushButton->setObjectName(QStringLiteral("num5PushButton"));
        ...
        num6PushButton->setObjectName(QStringLiteral("num6PushButton"));
        ...
        num1PushButton->setObjectName(QStringLiteral("num1PushButton"));
        ...
        num2PushButton->setObjectName(QStringLiteral("num2PushButton"));
        ...
        num3PushButton->setObjectName(QStringLiteral("num3PushButton"));
        ...
        num0PushButton->setObjectName(QStringLiteral("num0PushButton"));
        ...
        pointPushButton->setObjectName(QStringLiteral("pointPushButton"));
        ...
        rootsPushButton->setObjectName(QStringLiteral("rootsPushButton"));
        ...
        variablePushButton->setObjectName(QStringLiteral("variablePushButton"));
        ...
        subtractPushButton->setObjectName(QStringLiteral("subtractPushButton"));
        ...
        valuesPushButton->setObjectName(QStringLiteral("valuesPushButton"));
    ...
    {
        nonLinearAlgebra->setWindowTitle(QApplication::translate("nonLinearAlgebra", "Polynomial for Roots Tool", 0));
        groupBox->setTitle(QString());
        multiplyPushButton->setText(QApplication::translate("nonLinearAlgebra", "*", 0));
        addPushButton->setText(QApplication::translate("nonLinearAlgebra", "+", 0));
        backspacePushButton->setText(QApplication::translate("nonLinearAlgebra", "Backspace", 0));
        powerPushButton->setText(QApplication::translate("nonLinearAlgebra", "^", 0));
        numGroupBox->setTitle(QString());
        num7PushButton->setText(QApplication::translate("nonLinearAlgebra", "7", 0));
        num8PushButton->setText(QApplication::translate("nonLinearAlgebra", "8", 0));
        num9PushButton->setText(QApplication::translate("nonLinearAlgebra", "9", 0));
        num4PushButton->setText(QApplication::translate("nonLinearAlgebra", "4", 0));
        num5PushButton->setText(QApplication::translate("nonLinearAlgebra", "5", 0));
        num6PushButton->setText(QApplication::translate("nonLinearAlgebra", "6", 0));
        num1PushButton->setText(QApplication::translate("nonLinearAlgebra", "1", 0));
        num2PushButton->setText(QApplication::translate("nonLinearAlgebra", "2", 0));
        num3PushButton->setText(QApplication::translate("nonLinearAlgebra", "3", 0));
        num0PushButton->setText(QApplication::translate("nonLinearAlgebra", "0", 0));
        pointPushButton->setText(QApplication::translate("nonLinearAlgebra", ".", 0));
        iPushButton->setText(QApplication::translate("nonLinearAlgebra", "i", 0));
        clearPushButton->setText(QApplication::translate("nonLinearAlgebra", "Clear", 0));
        rightbracketPushButton->setText(QApplication::translate("nonLinearAlgebra", "\357\274\211", 0));
        leftbracketPushButton->setText(QApplication::translate("nonLinearAlgebra", "\357\274\210", 0));
        rootsPushButton->setText(QApplication::translate("nonLinearAlgebra", "Roots", 0));
        variablePushButton->setText(QApplication::translate("nonLinearAlgebra", "x", 0));
        subtractPushButton->setText(QApplication::translate("nonLinearAlgebra", "-", 0));
        cancelPushButton->setText(QApplication::translate("nonLinearAlgebra", "Cancel", 0));
        valuesPushButton->setText(QApplication::translate("nonLinearAlgebra", "Value", 0));
    } // retranslateUi
